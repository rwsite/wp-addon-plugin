...
trait HookTrait {
    public function addHook(string $hook, callable $callback, int $priority = 10, int $args = 1): void {
    ...
    public function addFilter(string $filter, callable $callback, int $priority = 10, int $args = 1): void {
