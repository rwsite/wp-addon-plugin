 ...
 * Возможные параметры для каждого поля, смотрите в: MetaBox::field()
 *
...
class MetaBox {
     ...
     */
    public function field( $args, $post ){
    ...
    // image
    public function field__image( $rg, $var, $post, $fn__desc, $fn__field ){
