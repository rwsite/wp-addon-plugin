<?php
/**
 * Widget API: RW_Widget_Archives class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
...
{
    add_action( 'widgets_init', 'archive_register_widget' );
    function archive_register_widget()
    {
        register_widget( 'RW_Widget_Archives' );
    }
}
 ...
 * @see WP_Widget
 */
class RW_Widget_Archives extends WP_Widget {
	...
	public function __construct() {
	    $this->title = __('Yearly Archives', 'wp-addon');
		$widget_ops = array(
			'classname' => 'widget_archive',
			'description' => __( 'A yearly archives.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct('year_archives', $this->title, $widget_ops);
	}
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? $this->title : $instance['title'], $instance, $this->id_base );
