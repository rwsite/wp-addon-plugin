...
$general['fields']['guid'] = [
        ...
        'fields'    => [
            ...
            [
                ...
                'help'  => __('Поле guid таблицы wp_posts создано для хранения там уникального значения - идентификатора записи. 
                                    ...
                                    Если это поле изменить, то ваши читатели RSS, могут получить кучу уже опубликованных материалов.', 'wp-addon'),
